...
<!---
  ...
  contact us at info@speclynx.com instead!

  Search open/closed issues before submitting!

  Issues on GitHub are only related to problems of the API Language Service
  itself. We'll try to offer support here for your use case, but we can't offer
  help with projects that use it indirectly.
