...
- **security:** update Axios to non-vulnerable 1.9.0 version ([#4926](https://github.com/swagger-api/apidom/issues/4926)) ([f6cab08](https://github.com/swagger-api/apidom/commit/f6cab08b6511498348f8151a611fcadab1eeb106))
...
- **reference:** use spec compliant JSON Pointer implementation ([#4904](https://github.com/swagger-api/apidom/issues/4904)) ([7af536a](https://github.com/swagger-api/apidom/commit/7af536a085c8d8c66b3b9e6085f21e62743de808)), closes [#4870](https://github.com/swagger-api/apidom/issues/4870)
...
- **json-path:** use spec compliant JSON Pointer evaluation ([#4873](https://github.com/swagger-api/apidom/issues/4873)) ([c8407d6](https://github.com/swagger-api/apidom/commit/c8407d691b0fc540dfd3476f61ce17611621e67b))

# [1.0.0-beta.32](https://github.com/swagger-api/apidom/compare/v1.0.0-beta.31...v1.0.0-beta.32) (2025-04-28)

### Bug Fixes

- **reference:** remove unnecessary dependency entries ([#4864](https://github.com/swagger-api/apidom/issues/4864)) ([90592a7](https://github.com/swagger-api/apidom/commit/90592a77d537a7e41efbd65052c0673195aa7bbd))
...
- **release:** fix lockfile sync job ([cd43add](https://github.com/swagger-api/apidom/commit/cd43adda3d5a4c0c1d53121778bd457099c1a540))

# [1.0.0-beta.26](https://github.com/swagger-api/apidom/compare/v1.0.0-beta.25...v1.0.0-beta.26) (2025-03-12)

### Bug Fixes

- **release:** pull changes before syncing lockfile ([4d33a8a](https://github.com/swagger-api/apidom/commit/4d33a8a01a2ddbdc166b8bee345cbda8b1df555f))

# [1.0.0-beta.25](https://github.com/swagger-api/apidom/compare/v1.0.0-beta.24...v1.0.0-beta.25) (2025-03-12)

### Bug Fixes

- separate syncing of lockfile to separate job ([cfa08a7](https://github.com/swagger-api/apidom/commit/cfa08a798810599bd7b9f1d389f8dd32c1e0e0be))
...
- ignore changes to husky ([1b6ac9f](https://github.com/swagger-api/apidom/commit/1b6ac9f0c697a866f6e0ba112e1fff7b38a5bead))
...
- **release:** add explicit step (no pulling) for syncing lockfile ([98ec21b](https://github.com/swagger-api/apidom/commit/98ec21b1eb50ee53c03351aed92ba7af426f2cbf))

# [1.0.0-beta.19](https://github.com/swagger-api/apidom/compare/v1.0.0-beta.18...v1.0.0-beta.19) (2025-03-12)

### Bug Fixes

- **release:** add explicit step for syncing lockfile ([fb26815](https://github.com/swagger-api/apidom/commit/fb2681596558e2a2f23803a53d70ab3b2afbc178))
...
- **release:** auto-fix package-lock.json after release ([#4787](https://github.com/swagger-api/apidom/issues/4787)) ([738577a](https://github.com/swagger-api/apidom/commit/738577ab4c6a4e047c1990172183f59b750ebe16))

# [1.0.0-beta.15](https://github.com/swagger-api/apidom/compare/v1.0.0-beta.14...v1.0.0-beta.15) (2025-03-11)

### Bug Fixes

- allow release to GitHub Package Registry ([#4785](https://github.com/swagger-api/apidom/issues/4785)) ([62f90f9](https://github.com/swagger-api/apidom/commit/62f90f9d411ebd7941ff63de5da265c93520b86e))

# [1.0.0-beta.14](https://github.com/swagger-api/apidom/compare/v1.0.0-beta.13...v1.0.0-beta.14) (2025-03-11)

### Bug Fixes

- allow release to GitHub Package Registry ([#4784](https://github.com/swagger-api/apidom/issues/4784)) ([ea44a94](https://github.com/swagger-api/apidom/commit/ea44a94786affb459735e286c62f5ac809e03383))
...
- implement YAML parser adapter for JSON Schema 2020-12 ([#4676](https://github.com/swagger-api/apidom/issues/4676)) ([57097f7](https://github.com/swagger-api/apidom/commit/57097f7432c93bfaabcd80be85c2bc97f3bb4b9e)), closes [#1868](https://github.com/swagger-api/apidom/issues/1868)
...
- **loggin:** include files needed by main entry point ([ccf46f6](https://github.com/swagger-api/apidom/commit/ccf46f6ee24d1303de2d01b6f2fce8d885039688)), closes [#4539](https://github.com/swagger-api/apidom/issues/4539)
- **parser-apadter-ads:** include files needed by main entry point ([9ca3749](https://github.com/swagger-api/apidom/commit/9ca37490e4f2dc9cbad009e3dbaac3d698e0445f)), closes [#4539](https://github.com/swagger-api/apidom/issues/4539)
