...
const completion: ApidomCompletionItem[] = [
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        '[Schema Object](https://spec.openapis.org/oas/v3.1.2.html#schema-object) | [Reference Object](https://spec.openapis.org/oas/v3.1.2.html#reference-object)\n\\\n\\\nThe schema defining the content of the request, response, or parameter.',
    },
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'Map[`string`, [Encoding Object](https://spec.openapis.org/oas/v3.1.2.html#encoding-object)]\n\\\n\\\nA map between a property name and its encoding information. The key, being the property name, MUST exist in the schema as a property. The encoding object SHALL only apply to `requestBody` objects when the media type is `multipart` or `application/x-www-form-urlencoded`.',
    },
    targetSpecs: OpenAPI31,
  },
];
