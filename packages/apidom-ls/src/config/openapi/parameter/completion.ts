...
const completion: ApidomCompletionItem[] = [
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        '**REQUIRED**. The name of the parameter. Parameter names are *case sensitive*.\n\n  * If [`in`](https://spec.openapis.org/oas/v3.1.2.html#parameter-in) is `"path"`, the `name` field MUST correspond to a template expression occurring within the [path](https://spec.openapis.org/oas/v3.1.2.html#paths-path) field in the [Paths Object](https://spec.openapis.org/oas/v3.1.2.html#paths-object). See [Path Templating](https://spec.openapis.org/oas/v3.1.2.html#path-templating) for further information.\n\n  * If [`in`](https://spec.openapis.org/oas/v3.1.2.html#parameter-in) is `"header"` and the `name` field is `"Accept"`, `"Content-Type"` or `"Authorization"`, the parameter definition SHALL be ignored.\n\n  * For all other cases, the `name` corresponds to the parameter name used by the [`in`](https://spec.openapis.org/oas/v3.1.2.html#parameter-in) property.',
    },
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'Determines whether this parameter is mandatory. If the [parameter location](https://spec.openapis.org/oas/v3.1.2.html#parameter-in) is `"path"`, this property is **REQUIRED** and its value MUST be `true`. Otherwise, the property MAY be included and its default value is `false`.',
    },
    targetSpecs: OpenAPI31,
  },
  {
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        '`boolean`\n\\\n\\\nSets the ability to pass empty-valued parameters. This is valid only for `query` parameters and allows sending a parameter with an empty value. Default value is `false`. If [`style`](https://spec.openapis.org/oas/v3.1.2.html#parameter-style) is used, and if behavior is `n/a` (cannot be serialized), the value of `allowEmptyValue` SHALL be ignored. Use of this property is NOT RECOMMENDED, as it is likely to be removed in a later revision.',
    },
    targetSpecs: OpenAPI31,
  },
  {
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'When this is true, parameter values of type `array` or `object` generate separate parameters for each value of the array or key-value pair of the map. For other types of parameters this property has no effect. When [`style`](https://spec.openapis.org/oas/v3.1.2.html#parameter-style) is `form`, the default value is `true`. For all other styles, the default value is `false`.',
    },
    targetSpecs: OpenAPI31,
  },
  {
