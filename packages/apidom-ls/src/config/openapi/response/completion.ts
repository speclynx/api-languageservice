...
const completion: ApidomCompletionItem[] = [
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'Map[`string`, [Media Object](https://spec.openapis.org/oas/v3.1.2.html#media-type-object)]\n\\\n\\\nA map containing descriptions of potential response payloads. The key is a media type or [media type range](https://tools.ietf.org/html/rfc7231#appendix-D) and the value describes it. For responses that match multiple keys, only the most specific key is applicable. e.g. text/plain overrides text/*',
    },
    targetSpecs: OpenAPI31,
  },
  {
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'Map[`string`, [Link Object](https://spec.openapis.org/oas/v3.1.2.html#link-object) &#124; [Reference Object](https://spec.openapis.org/oas/v3.1.2.html#reference-object)]\n\\\n\\\nA map of operations links that can be followed from the response. The key of the map is a short name for the link, following the naming constraints of the names for [Component Objects](https://spec.openapis.org/oas/v3.1.2.html#components-object).',
    },
    targetSpecs: OpenAPI31,
  },
];
