# @char0n/apidom-ns-openapi-3-0

`@char0n/apidom-ns-openapi-3-0` contains ApiDOM namespace supports following OpenAPI specification versions:
...
OpenAPI 3.0.x namespace consists of [number of elements](https://github.com/char0n/apidom/tree/main/packages/apidom-ns-openapi-3-0/src/elements) implemented on top
of [primitive ones](https://github.com/refractproject/minim/tree/master/lib/primitives).

```js
import { createNamespace } from '@char0n/apidom-core';
import openApi3_0Namespace from '@char0n/apidom-ns-openapi-3-0';
...
```js
import { OpenApi3_0Element, InfoElement } from '@char0n/apidom-ns-openapi-3-0';
...
This package exposes [predicates](https://github.com/char0n/apidom/blob/main/packages/apidom-ns-openapi-3-0/src/predicates.ts)
for all higher order elements that are part of this namespace.

```js
import { isOpenApi3_0Element, OpenApi3_0Element } from '@char0n/apidom-ns-openapi-3-0';
...
This package comes with its own [keyMap](https://github.com/char0n/apidom/blob/main/packages/apidom-ns-openapi-3-0/src/traversal/visitor.ts#L11) and [nodeTypeGetter](https://github.com/char0n/apidom/blob/main/packages/apidom-ns-openapi-3-0/src/traversal/visitor.ts#L4).
...
import { OpenApi3_0Element, keyMap, getNodeType } from '@char0n/apidom-ns-openapi-3-0';
...
import { refractorPluginReplaceEmptyElement, OpenApi3_0Element } from '@char0n/apidom-ns-openapi-3-0';
