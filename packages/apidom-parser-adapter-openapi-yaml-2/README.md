...
[Detection](https://github.com/char0n/apidom/blob/main/packages/apidom-parser-adapter-openapi-yaml-3-0/src/adapter.ts#L11) is based on a regular expression matching required OpenAPI 2.0 specification symbols in YAML format.
...
--- | --- | --- | ---
<a name="specObj"></a>`specObj` | `Object` | [Specification Object](https://github.com/char0n/apidom/blob/main/packages/apidom-ns-openapi-2/src/refractor/specification.ts) | This specification object drives the YAML AST transformation to OpenAPI 2.0 ApiDOM namespace.
