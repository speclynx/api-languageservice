# @char0n/apidom-parser-adapter-json-schema-yaml-2020-12

`@char0n/apidom-parser-adapter-json-schema-yaml-2020-12` is a parser adapter for the [JSON Schema 2020-12](https://json-schema.org/draft/2020-12/draft-bhutton-json-schema-01) in [YAML format](https://yaml.org/spec/1.2/spec.html).
...
[Detection](https://github.com/char0n/apidom/blob/main/packages/apidom-parser-adapter-json-schema-yaml-2020-12/src/adapter.ts#L13) is based on a regular expression matching required JSON Schema 2020-12 symbols in YAML format.
...
--- | --- | --- | ---
<a name="specObj"></a>`specObj` | `Object` | [Specification Object](https://github.com/char0n/apidom/blob/main/packages/apidom-ns-json-schema-2020-12/src/refractor/specification.ts) | This specification object drives the YAML AST transformation to JSON Schema 2020-12 ApiDOM namespace.
...
```js
import { parse, detect } from '@char0n/apidom-parser-adapter-json-schema-yaml-2020-12';
...
import * as jsonSchemaYamlAdapter from '@char0n/apidom-parser-adapter-json-schema-yaml-2020-12';
