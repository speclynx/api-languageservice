# @char0n/apidom-json-pointer-relative
...
import { evaluate } from '@char0n/apidom-json-pointer-relative';
...
```js
import { parse } from '@char0n/apidom-json-pointer-relative';
...
```js
import { compile } from '@char0n/apidom-json-pointer-relative';
...
```js
import { InvalidRelativeJsonPointerError } from '@char0n/apidom-json-pointer-relative';
```
...
```js
import { EvaluationRelativeJsonPointerError } from '@char0n/apidom-json-pointer-relative';
```
