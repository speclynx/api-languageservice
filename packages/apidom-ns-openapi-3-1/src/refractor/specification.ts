...
import ContactVisitor from './visitors/open-api-3-1/contact/index.ts';
...
import SecurityRequirementVisitor from './visitors/open-api-3-1/security-requirement/index.ts';
import ComponentsVisitor from './visitors/open-api-3-1/components/index.ts';
import TagVisitor from './visitors/open-api-3-1/tag/index.ts';
import ReferenceVisitor from './visitors/open-api-3-1/reference/index.ts';
import ParameterVisitor from './visitors/open-api-3-1/parameter/index.ts';
import HeaderVisitor from './visitors/open-api-3-1/header/index.ts';
import SchemaVisitor from './visitors/open-api-3-1/schema/index.ts';
import Schema$defsVisitor from './visitors/open-api-3-1/schema/$defsVisitor.ts';
import SchemaAllOfVisitor from './visitors/open-api-3-1/schema/AllOfVisitor.ts';
import SchemaAnyOfVisitor from './visitors/open-api-3-1/schema/AnyOfVisitor.ts';
import SchemaOneOfVisitor from './visitors/open-api-3-1/schema/OneOfVisitor.ts';
import SchemaDependantSchemasVisitor from './visitors/open-api-3-1/schema/DependentSchemasVisitor.ts';
import SchemaPrefixItemsVisitor from './visitors/open-api-3-1/schema/PrefixItemsVisitor.ts';
import SchemaPropertiesVisitor from './visitors/open-api-3-1/schema/PropertiesVisitor.ts';
import SchemaPatternPropertiesVisitor from './visitors/open-api-3-1/schema/PatternPropertiesVisitor.ts';
import DiscriminatorVisitor from './visitors/open-api-3-1/distriminator/index.ts';
import XmlVisitor from './visitors/open-api-3-1/xml/index.ts';
import ComponentsSchemasVisitor from './visitors/open-api-3-1/components/SchemasVisitor.ts';
import ComponentsPathItemsVisitor from './visitors/open-api-3-1/components/PathItemsVisitor.ts';
import ExampleVisitor from './visitors/open-api-3-1/example/index.ts';
import ExternalDocumentationVisitor from './visitors/open-api-3-1/external-documentation/index.ts';
import EncodingVisitor from './visitors/open-api-3-1/encoding/index.ts';
import PathsVisitor from './visitors/open-api-3-1/paths/index.ts';
import RequestBodyVisitor from './visitors/open-api-3-1/request-body/index.ts';
import CallbackVisitor from './visitors/open-api-3-1/callback/index.ts';
import ResponseVisitor from './visitors/open-api-3-1/response/index.ts';
import ResponsesVisitor from './visitors/open-api-3-1/responses/index.ts';
import OperationVisitor from './visitors/open-api-3-1/operation/index.ts';
import PathItemVisitor from './visitors/open-api-3-1/path-item/index.ts';
import SecuritySchemeVisitor from './visitors/open-api-3-1/security-scheme/index.ts';
import OAuthFlowsVisitor from './visitors/open-api-3-1/oauth-flows/index.ts';
import OAuthFlowVisitor from './visitors/open-api-3-1/oauth-flow/index.ts';
import WebhooksVisitor from './visitors/open-api-3-1/WebhooksVisitor.ts';
