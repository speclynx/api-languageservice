...
describe('dereference', function () {
  context('strategies', function () {
    context('asyncapi-2', function () {
      context('Operation Trait Object', function () {
        ...
        context('given in components/operationTraits field', function () {
          const fixturePath = path.join(rootFixturePath, 'components-operation-traits');
