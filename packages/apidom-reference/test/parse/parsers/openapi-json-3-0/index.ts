...
import { mediaTypes } from '@char0n/apidom-parser-adapter-openapi-json-3-0';
import { fileURLToPath } from 'node:url';

import File from '../../../../src/File.ts';
import OpenAPIJSON3_0Parser from '../../../../src/parse/parsers/openapi-json-3-0/index.ts';
...
describe('parsers', function () {
  context('OpenAPIJSON3_0Parser', function () {
    ...
    context('parse', function () {
      ...
      context('given data that is not an OpenApi 3.0.x JSON data', function () {
