...
Base namespace consists of [four higher order elements](https://github.com/char0n/apidom/tree/main/packages/apidom-core/src/elements) implemented on top
...
This package exposes [predicates](https://github.com/char0n/apidom/blob/main/packages/apidom-core/src/predicates/index.ts)
...
[Predicate helpers](https://github.com/char0n/apidom/blob/main/packages/apidom-core/src/predicates/helpers.ts)
...
Our [transcluder](https://github.com/char0n/apidom/tree/main/packages/apidom-core/src/transcluder) does exactly that and is based on mutating algorithm.
...
When multiple transclusions are going to be performed use [Transcluder stamp](https://github.com/char0n/apidom/blob/main/packages/apidom-core/src/transcluder/Transcluder.ts)
...
[visit](https://github.com/char0n/apidom/blob/main/packages/apidom-core/src/traversal/visitor.ts#L104-L103) will walk through an AST using a depth first traversal, calling
...
to remove the value, or to stop the whole traversal by returning [BREAK](https://github.com/char0n/apidom/blob/main/packages/apidom-core/src/index.ts#L52).
...
This function originally comes from [@char0n/apidom-ast package](https://github.com/char0n/apidom/blob/main/packages/apidom-ast/src/visitor.ts)
