...
const documentation = [
  {
    target: 'overlay',
    docs: '**REQUIRED**. This string MUST be the [version number](https://spec.openapis.org/overlay/v1.0.0.html#versions) of the Overlay Specification that the Overlay document uses. The `overlay` field SHOULD be used by tooling to interpret the Overlay document.',
