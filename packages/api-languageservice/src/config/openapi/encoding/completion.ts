...
const completion: ApidomCompletionItem[] = [
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'Describes how a specific property value will be serialized depending on its type.  See [Parameter Object](https://spec.openapis.org/oas/v3.1.2.html#parameter-object) for details on the [`style`](https://spec.openapis.org/oas/v3.1.2.html#parameter-style) property. The behavior follows the same values as `query` parameters, including default values. This property SHALL be ignored if the request body media type is not `application/x-www-form-urlencoded` or `multipart/form-data`. If a value is explicitly defined, then the value of [`contentType`](https://spec.openapis.org/oas/v3.1.2.html#encoding-content-type) (implicit or explicit) SHALL be ignored.',
    },
    targetSpecs: OpenAPI31,
  },
  {
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'When this is true, property values of type `array` or `object` generate separate parameters for each value of the array, or key-value-pair of the map.  For other types of properties this property has no effect. When [`style`](https://spec.openapis.org/oas/v3.1.2.html#encoding-style) is `form`, the default value is `true`. For all other styles, the default value is `false`. This property SHALL be ignored if the request body media type is not `application/x-www-form-urlencoded` or `multipart/form-data`. If a value is explicitly defined, then the value of [`contentType`](https://spec.openapis.org/oas/v3.1.2.html#encoding-content-type) (implicit or explicit) SHALL be ignored.',
    },
    targetSpecs: OpenAPI31,
  },
  {
