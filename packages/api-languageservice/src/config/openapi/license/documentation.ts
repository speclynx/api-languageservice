...
const documentation = [
  ...
  {
    target: 'url',
    docs: 'A URI to the license used for the API. This MUST be in the form of a URI. The `url` field is mutually exclusive of the `identifier` field.',
    targetSpecs: OpenAPI31,
  },
  {
