...
const documentation = [
  {
    target: 'type',
    docs: '**Required.** The type of the security scheme. Valid values are `"basic"`, `"apiKey"` or `"oauth2"`.',
  ...
  {
    target: 'description',
    docs: 'A short description for security scheme.',
    targetSpecs: OpenAPI2,
  },
  {
    target: 'description',
  ...
  {
    target: 'name',
    docs: 'Valid for `apiKey`. **Required**. The name of the header or query parameter to be used.',
    targetSpecs: OpenAPI2,
  },
  {
    target: 'name',
  ...
  {
    target: 'in',
    docs: 'Valid for `apiKey`. **Required**. The location of the API key. Valid values are `"query"` or `"header"`.',
    targetSpecs: OpenAPI2,
  },
  {
    target: 'in',
  ...
  {
    target: 'flow',
    docs: 'Valid for `oauth2`. **Required**. The flow used by the OAuth2 security scheme. Valid values are `"implicit"`, `"password"`, `"application"` or `"accessCode"`.',
    targetSpecs: OpenAPI2,
  },
  {
    target: 'flows',
  ...
  },
  {
    ...
    docs: 'Valid for oauth2 (`"implicit"`, `"accessCode"`). **Required**. The authorization URL to be used for this flow. This SHOULD be in the form of a URL.',
    targetSpecs: OpenAPI2,
  },
  {
    target: 'tokenUrl',
    docs: 'Valid for oauth2 (`"password"`, `"application"`, `"accessCode"`). **Required**. The token URL to be used for this flow. This SHOULD be in the form of a URL.',
    targetSpecs: OpenAPI2,
  },
  {
    target: 'openIdConnectUrl',
    docs: 'Applies to `openIdConnect`. **REQUIRED**. OpenId Connect URL to discover OAuth2 configuration values. This MUST be in the form of a URL.',
    targetSpecs: OpenAPI30,
  },
  {
    target: 'scopes',
