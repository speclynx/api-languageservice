...
const completion: ApidomCompletionItem[] = [
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        '[External Documentation](https://spec.openapis.org/oas/v3.1.2.html#external-documentation-object)\n\\\n\\\nAdditional external documentation for this operation.',
    },
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        '[[Request Body Object](https://spec.openapis.org/oas/v3.1.2.html#request-body-object) &#124; [Reference Object](https://spec.openapis.org/oas/v3.1.2.html#reference-object)]\n\\\n\\\nThe request body applicable for this operation. The requestBody is fully supported in HTTP methods where the HTTP 1.1 specification [RFC7231](https://tools.ietf.org/html/rfc7231#section-4.3.1) has explicitly defined semantics for request bodies. In other cases where the HTTP spec is vague (such as [GET](https://tools.ietf.org/html/rfc7231#section-4.3.1), [HEAD](https://tools.ietf.org/html/rfc7231#section-4.3.2) and [DELETE](https://tools.ietf.org/html/rfc7231#section-4.3.5)), `requestBody` is permitted but does not have well-defined semantics and SHOULD be avoided if possible.',
    },
    targetSpecs: OpenAPI31,
  },
  {
