...
const completion: ApidomCompletionItem[] = [
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'A relative or absolute URI reference to an OAS operation. This field is mutually exclusive of the `operationId` field, and MUST point to an [Operation Object](https://spec.openapis.org/oas/v3.1.2.html#operation-object). Relative `operationRef` values MAY be used to locate an existing [Operation Object](https://spec.openapis.org/oas/v3.1.2.html#operation-object) in the OpenAPI definition. See the rules for resolving [Relative References](https://spec.openapis.org/oas/v3.1.2.html#relative-references-in-uris).',
    },
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'Map[`string`, Any &#124; [`{expression}`](https://spec.openapis.org/oas/v3.1.2.html#runtime-expressions)]\n\\\n\\\nA map representing parameters to pass to an operation as specified with `operationId` or identified via `operationRef`. The key is the parameter name to be used, whereas the value can be a constant or an expression to be evaluated and passed to the linked operation. The parameter name can be qualified using the [parameter location](https://spec.openapis.org/oas/v3.1.2.html#parameter-in) `[{in}.]{name}` for operations that use the same parameter name in different locations (e.g. path.id).',
    },
    targetSpecs: OpenAPI31,
  },
  {
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'Any &#124; [`{expression}`](https://spec.openapis.org/oas/v3.1.2.html#runtime-expressions)\n\\\n\\\nA literal value or [`{expression}`](https://spec.openapis.org/oas/v3.1.2.html#runtime-expressions) to use as a request body when calling the target operation.',
    },
    targetSpecs: OpenAPI31,
  },
  {
