...
const documentation = [
  ...
  {
    target: 'url',
    docs: '**REQUIRED**. The URI for the target documentation. This MUST be in the form of a URI.',
    targetSpecs: OpenAPI3,
  },
  {
