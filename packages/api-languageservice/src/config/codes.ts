...
enum ApilintCodes {
  ...
  OPENAPI2_TAG = 3190000,
  OPENAPI2_TAG_FIELD_NAME_TYPE = 3190100,
  ...
  OPENAPI3_0_OPENAPI_VALUE_PATTERN_3_0_X,
  ...
  OPENAPI3_1_OPENAPI_VALUE_PATTERN_3_1_1 = 7000200,
  OPENAPI3_1_OPENAPI_VALUE_PATTERN_3_1_2 = 7000300,
  OPENAPI3_1_OPENAPI_VALUE_PATTERN_3_1_X = 7000400,
  ...
  JSON_SCHEMA_2020_12_KEYWORD_$REF_FORMAT_URI = 8030300,
  JSON_SCHEMA_2020_12_KEYWORD_$COMMENT_TYPE = 8030400,
  ...
  ARAZZO_SPEC_FIELD_$SELF_TYPE = 9020700,
  ARAZZO_SPEC_FIELD_$SELF_FORMAT_URI = 9020701,
  ARAZZO_SPEC_FIELD_$SELF_NO_FRAGMENT = 9020702,
  ...
  ARAZZO_WORKFLOW_FIELD_DEPENDS_ON_SOURCE_TYPE = 9040503,
  ...
  ARAZZO_STEP_FIELD_WORKFLOW_ID_PATTERN = 9050305,
  ARAZZO_STEP_FIELD_OPERATION_ID_SOURCE_TYPE = 9050306,
  ARAZZO_STEP_FIELD_WORKFLOW_ID_SOURCE_TYPE = 9050307,
  ARAZZO_STEP_FIELD_CHANNEL_PATH_TYPE = 9051100,
  ARAZZO_STEP_FIELD_CHANNEL_PATH_MUTUALLY_EXCLUSIVE = 9051101,
  ARAZZO_STEP_FIELD_TIMEOUT_TYPE = 9051200,
  ARAZZO_STEP_FIELD_CORRELATION_ID_ONLY_ACTION_RECEIVE = 9051300,
  ARAZZO_STEP_FIELD_CORRELATION_ID_REQUIRES_ACTION = 9051301,
  ARAZZO_STEP_FIELD_ACTION_TYPE = 9051400,
  ARAZZO_STEP_FIELD_ACTION_EQUALS = 9051401,
  ARAZZO_STEP_FIELD_DEPENDS_ON_TYPE = 9051500,
  ARAZZO_STEP_FIELD_DEPENDS_ON_UNIQUE = 9051501,
  ARAZZO_STEP_FIELD_DEPENDS_ON_RESOLVED = 9051502,
  ARAZZO_STEP_FIELD_DEPENDS_ON_SOURCE_TYPE = 9051503,
  ...
  ARAZZO_SUCCESS_ACTION_FIELD_WORKFLOW_ID_PATTERN = 9070302,
  ARAZZO_SUCCESS_ACTION_FIELD_WORKFLOW_ID_SOURCE_TYPE = 9070303,
  ARAZZO_SUCCESS_ACTION_FIELD_STEP_ID_RESOLVED = 9070401,
  ARAZZO_SUCCESS_ACTION_FIELD_STEP_ID_PATTERN = 9070402,
  ARAZZO_SUCCESS_ACTION_FIELD_PARAMETERS_TYPE = 9070700,
  ARAZZO_SUCCESS_ACTION_FIELD_PARAMETERS_ONLY_WORKFLOW_ID = 9070701,
  ...
  ARAZZO_FAILURE_ACTION_FIELD_WORKFLOW_ID_PATTERN = 9080302,
  ARAZZO_FAILURE_ACTION_FIELD_WORKFLOW_ID_SOURCE_TYPE = 9080303,
  ARAZZO_FAILURE_ACTION_FIELD_STEP_ID_RESOLVED = 9080401,
  ARAZZO_FAILURE_ACTION_FIELD_STEP_ID_PATTERN = 9080402,
  ARAZZO_FAILURE_ACTION_FIELD_PARAMETERS_TYPE = 9081000,
  ARAZZO_FAILURE_ACTION_FIELD_PARAMETERS_ONLY_WORKFLOW_ID = 9081001,
  ...
  // Expression Type Object (renamed from Criterion Expression Type Object in Arazzo 1.1;
  // shared by Criterion, Selector, and Payload Replacement Objects)
  ARAZZO_EXPRESSION_TYPE = 9110000,
  ARAZZO_EXPRESSION_TYPE_FIELD_TYPE_REQUIRED = 9110100,
  ARAZZO_EXPRESSION_TYPE_FIELD_TYPE_TYPE = 9110101,
  ARAZZO_EXPRESSION_TYPE_FIELD_TYPE_EQUALS = 9110102,
  ARAZZO_EXPRESSION_TYPE_FIELD_VERSION_REQUIRED = 9110200,
  ARAZZO_EXPRESSION_TYPE_FIELD_VERSION_TYPE = 9110201,
  ARAZZO_EXPRESSION_TYPE_FIELD_VERSION_EQUALS_JSONPATH = 9110300,
  ARAZZO_EXPRESSION_TYPE_FIELD_VERSION_EQUALS_XPATH = 9110301,
  ARAZZO_EXPRESSION_TYPE_FIELD_VERSION_EQUALS_JSONPOINTER = 9110302,
  ...
  ARAZZO_PAYLOAD_REPLACEMENT_FIELD_TARGET_SELECTOR_TYPE_TYPE = 9130300,
  ARAZZO_PAYLOAD_REPLACEMENT_FIELD_TARGET_SELECTOR_TYPE_EQUALS = 9130301,
  ...
  // Selector Object (introduced in Arazzo 1.1)
  // `context`, `selector` and `type` have no "required" codes: apidom only disambiguates an
  // object as a `selector` element once all three are already present (see
  // OAI/Arazzo-Specification#519), so those checks could never fire.
  ARAZZO_SELECTOR = 9150000,
  ARAZZO_SELECTOR_FIELD_CONTEXT_TYPE = 9150101,
  ARAZZO_SELECTOR_FIELD_SELECTOR_TYPE = 9150201,
  ARAZZO_SELECTOR_FIELD_TYPE_TYPE = 9150301,
  ARAZZO_SELECTOR_FIELD_TYPE_EQUALS = 9150302,

  OVERLAY = 10000000,
  OVERLAY_NOT_DETECTED = 10000001,

  // Overlay Specification Object (root)
  OVERLAY_SPEC = 10010000,
  OVERLAY_SPEC_FIELD_OVERLAY_REQUIRED = 10010100,
  OVERLAY_SPEC_FIELD_OVERLAY_TYPE = 10010101,
  OVERLAY_SPEC_FIELD_OVERLAY_PATTERN = 10010102,
  OVERLAY_SPEC_FIELD_INFO_REQUIRED = 10010200,
  OVERLAY_SPEC_FIELD_INFO_TYPE = 10010201,
  OVERLAY_SPEC_FIELD_EXTENDS_TYPE = 10010300,
  OVERLAY_SPEC_FIELD_EXTENDS_FORMAT_URI = 10010301,
  OVERLAY_SPEC_FIELD_ACTIONS_REQUIRED = 10010400,
  OVERLAY_SPEC_FIELD_ACTIONS_TYPE = 10010401,
  OVERLAY_SPEC_FIELD_ACTIONS_NON_EMPTY = 10010402,
  OVERLAY_SPEC_NO_SCRIPT_TAGS = 10010500,

  // Overlay Info Object
  OVERLAY_INFO = 10020000,
  OVERLAY_INFO_FIELD_TITLE_REQUIRED = 10020100,
  OVERLAY_INFO_FIELD_TITLE_TYPE = 10020101,
  OVERLAY_INFO_FIELD_VERSION_REQUIRED = 10020200,
  OVERLAY_INFO_FIELD_VERSION_TYPE = 10020201,
  OVERLAY_INFO_FIELD_DESCRIPTION_TYPE = 10020300,

  // Overlay Action Object
  OVERLAY_ACTION = 10030000,
  OVERLAY_ACTION_FIELD_TARGET_REQUIRED = 10030100,
  OVERLAY_ACTION_FIELD_TARGET_TYPE = 10030101,
  OVERLAY_ACTION_FIELD_TARGET_JSONPATH_VALID = 10030102,
  OVERLAY_ACTION_FIELD_DESCRIPTION_TYPE = 10030200,
  OVERLAY_ACTION_FIELD_UPDATE_COPY_MUTUALLY_EXCLUSIVE = 10030300,
  OVERLAY_ACTION_FIELD_COPY_TYPE = 10030400,
  OVERLAY_ACTION_FIELD_COPY_JSONPATH_VALID = 10030401,
  OVERLAY_ACTION_FIELD_REMOVE_TYPE = 10030500,
  OVERLAY_ACTION_FIELD_UPDATE_REMOVE_MUTUALLY_EXCLUSIVE = 10030600,
  OVERLAY_ACTION_FIELD_COPY_REMOVE_MUTUALLY_EXCLUSIVE = 10030700,
}
